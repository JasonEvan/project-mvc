        ...
        <div class="col">
            <form action="<?= BASEURL; ?>/daftar/tambahsupplier" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_supplier" aria-describedby="nama_supplier" name="nama_supplier" required>
                </div>
                <div class="mb-3">
                    <label for="kota_supplier" class="form-label">Kota</label>
                    <input type="text" class="form-control" id="kota_supplier" name="kota_supplier" required>
                </div>
                <div class="mb-3">
